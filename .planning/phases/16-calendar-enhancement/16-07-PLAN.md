...
async function verifyPhase16() {
  ...
  try {
    ...
    if (weekSelector && bulkTagModal) pass('CALENDAR-07: Bulk selection and tag modal exist');
    else if (weekSelector) fail('CALENDAR-07', 'Week selectors exist but bulkTagModal not found');
    else fail('CALENDAR-07', 'Week selector controls not found');
