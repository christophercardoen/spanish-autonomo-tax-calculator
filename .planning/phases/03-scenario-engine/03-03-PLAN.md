...
<task type="auto">
  <name>Task 2: Implement renderComparisonTable function</name>
  <files>autonomo_dashboard.html</files>
  <action>
...
6. Uncheck Scenario A - column disappears from table
  ...
  <done>
Comparison table renders for selected scenarios. Full calculation breakdown visible. Sticky header row works. Optimal values highlighted. Table updates on selection change.
  </done>
</task>
...
<verification>
1. Load autonomo_dashboard.html in browser
