...
function createConstantsSheet(workbook) {
  ...
  sheet.headerFooter = {
    oddHeader: '&C&"Arial,Bold"Fiscal Constants 2025/2026',
    oddFooter: '&LPage &P&R&D'
  };

  // ========== SHEET PROTECTION ==========
  // Protect Constants sheet from accidental edits
  // Note: This is a basic protection without password
  sheet.protect('', {
...
function createScenarioSheet(workbook, scenario) {
  ...
  sheet.headerFooter = {
    oddHeader: `&C&"Arial,Bold"Scenario ${scenario.id} - ${scenario.label} | Spanish Autonomo Tax Calculator`,
    oddFooter: '&LPage &P&R&D'
  };
...
function createOverviewSheet(workbook, scenarios) {
  ...
  // Add generator note as cell comment
  sheet.getCell('A1').note = {
    texts: [
      { text: 'Generated by autonomo_calculator\n', font: { bold: true } },
  ...
  sheet.headerFooter = {
    oddHeader: '&C&"Arial,Bold"Spanish Autonomo Tax Calculator - Overview',
